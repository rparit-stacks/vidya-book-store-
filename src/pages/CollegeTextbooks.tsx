...
const CollegeTextbooks = () => {
  ...
  return (
    <Layout>
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-purple-50 via-background to-cream py-20 md:py-28">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-block px-4 py-1.5 bg-purple-500/10 text-purple-600 text-sm font-medium rounded-full mb-4">
                University & College
              </span>
